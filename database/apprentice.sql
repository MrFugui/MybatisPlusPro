...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博客表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of blog
-- ----------------------------
INSERT INTO `blog` VALUES (1, 'string', 'string', 0, 1, 7, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (2, 'string', 'string', 0, 2, 6, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (3, 'string', 'string', 0, 3, 5, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (4, 'string', 'string', 0, 4, 4, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (5, 'string', 'string', 0, 5, 3, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (6, 'string', 'string', 0, 6, 2, NULL, 0, 0, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (7, 'string', 'string', 0, 7, 1, NULL, 0, NULL, 0, 0, 0, 0, 'string');
INSERT INTO `blog` VALUES (8, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `blog` VALUES (9, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `blog` VALUES (10, 'string', 'string', 0, 0, 0, '2021-11-26 08:52:28', 0, 0, 0, 0, 0, 0, 'string');
